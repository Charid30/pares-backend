// src/models/candidatureOffre.js
const { DataTypes } = require('sequelize');

module.exports = (sequelize) => {
  const CandidatureOffre = sequelize.define('candidature_offre', {
    idcandidature: {
    ...
    tableName: 'candidature_offre',
    timestamps: false,
    indexes: [
      {
        unique: true,
        fields: ['offres_idoffres', 'candidats_idcandidats'],
        name: 'unique_candidature_offre'
      }
    ],
  });
